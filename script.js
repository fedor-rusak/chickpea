 ...
 */
"use strict";
var glMatrixArrayType = Float32Array;
...
var startData = [
	...
	{"do": "setCamera", "x": 0, "y": 0, "z": 10},
	{"do": "setCameraOrtho", "x": 0, "y": 0, "z": 10},
	{"do": "disableDepthTesting"},
	{"do": "enableAlphaBlending"},
	[
		{"do": "scale", "xScale": 20, "yScale": 20},
		{"do": "translate", "x": -startDimensions[0]/2+20, "y": startDimensions[1]/2-20, "z": -10},
		{"do": "renderText", "text": "Z"}
	]
];
...
var natives = {
	"rotateAxisAngles": rotateAxisAngles,
	"rotate3d": rotate3d,

	"clearScreen": function() {},
	"setCamera": function() {},
	"setCameraOrtho": function() {},
	"enableDepthTesting": function() {},
	"disableDepthTesting": function() {},
	"enableAlphaBlending": function() {},
	"disableAlphaBlending": function() {},
	"renderOneColoredPolygons": function() {},
	"renderOneColoredLitPolygons": function() {},
	"renderTexturedSquare": function() {},
	"renderScaledTexturedSquare": function() {},
	"renderText": function() {},
};
...
combineTransformations = function() {
	var realFunction = combineTransformations;

	return function(current, propagated, destination) {
		var start = Date.now();
		var result = realFunction(current, propagated, destination);
		var end = Date.now();
...
var getDefaultTransformations = function() {
...
var renderHelper = function(serializedCommands, propagatedTransformations) {
	...
	for (var i = 0; i < serializedCommands.length; i++) {
		...
		else if (block.do === "setCameraOrtho") {
			natives.setCameraOrtho(block.x || 0, block.y || 0, block.z || 0,
			block.xa || 0, block.ya || 0, block.za || 0, block.a || 0);
		}
...
// print(hamiltonProduct(hamiltonProduct(getQuatFromAxisAngle(0,0,1,90), [1,0,0,0]), getQuatFromAxisAngle(0,0,-1,90)));
// print(rotate3d(1,0,0, 0,0,1, 90));
var end = Date.now();
